...
namespace _01_DAL
{
    ...
    {
        static MySqlConnection Connection = new MySqlConnection(@"SERVER=127.0.0.1;PORT=3306;UID=root;persistsecurityinfo=True;DATABASE=taskmanagment;SslMode = none");
